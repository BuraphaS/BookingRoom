        ...
        <tr>
          ...
          {Booking.map((val, index) => (
              ...
              >
                <Box sx={style}>
                  ...
                  <Typography id="modal-modal-description" sx={{ mt: 3 }}>
                    <Tab2>
                      <table style={{ border: '1px solid #000000', borderCollapse: 'collapse', height: '600px' }}>
            ...
            <tr>
              ...
              <td style={{ width: '800PX', border: '1px solid #000000', paddingLeft: '7px' }}>
                <p>{formatDate(val.create_date)}</p>
              </td>
            </tr>
          <tr>
            ...
            <tr>
              ...
              <td style={{ width: '800PX', border: '1px solid #000000', paddingLeft: '7px' }}>
                <p>{formatDate(val.begin)} ถึง {formatDate(val.end)}</p>
              </td>
            </tr>
            <tr>
              <td style={{ width: '300PX', border: '1px solid #000000', paddingLeft: '7px' }}>
              ...
              <td style={{ width: '800PX', border: '1px solid #000000', paddingLeft: '7px' }}>
                <p>{formatTime(val.time_begin)} ถึง {formatTime(val.time_end)}</p>
              </td>
            </tr>
            <tr>
              <td style={{ width: '300PX', border: '1px solid #000000', paddingLeft: '7px' }}>
